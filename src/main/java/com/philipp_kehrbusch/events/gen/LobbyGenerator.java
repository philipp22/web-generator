...
public class LobbyGenerator {
  ...
  public static void main(String[] args) throws WebDomainGeneratorException {
    ...
    var genSettings = new GeneratorSettings(
            "/home/philipp/Dokumente/programmierung/events-gen/eventsgen/src/main/resources/model-lobby")
            .trafoBasePackage("com.philipp_kehrbusch.events.gen")
            .addTarget(Targets.BACKEND, new Target(
                    Target.JAVA,
                    "/home/philipp/Dokumente/programmierung/gaming/gaminglobbymanager/src/main/gen",
                    "/home/philipp/Dokumente/programmierung/gaming/gaminglobbymanager/src/main/java",
                    FileNameResolvers.JAVA,
                    "java/Artifact.ftl",
                    "com.philipp_kehrbusch.gaming.lobby",
                    "gaminglobbymanager"));
    ...
    try {
      new ProcessBuilder(
              "prettier",
              "--write",
              "/home/philipp/Dokumente/programmierung/gaming/gaminglobbymanager/src/main/gen/**/*.java"
